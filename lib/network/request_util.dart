...
class HttpGo {
  ...
  HttpGo._internal() {
    if (!configured) {
      LogUtils.w("you have not config the dio!");
    }
  ...
  Future<ApiResponseEntity<T>> request<T>(String url, String method,
      {Object? data,
    ...
    try {
      ...
      result = ApiResponseEntity.fromJson(map);
      //todo wjf
      // if (result.errorCode == Constant.invalidateToken) {
      //     User().logout();
      // }
    } on DioException catch (error) {
      LogUtils.e("request error-- $error");
      result = ApiResponseEntity();
      result.errorCode = Constant.otherError;
  ...
  Future<ApiResponseEntity<T>> get<T>(String url,
      {Object? data,
      Map<String, dynamic>? queryParams,
      CancelToken? cancelToken,
      Options? options,
  ...
  Future<ApiResponseEntity<T>> post<T>(String url,
      {Object? data,
      Map<String, dynamic>? queryParams,
      CancelToken? cancelToken,
      Options? options,
  ...
  Future<ApiResponseEntity<T>> delete<T>(String url,
      {Object? data,
      Map<String, dynamic>? queryParams,
      CancelToken? cancelToken,
      Options? options,
  ...
  Future<ApiResponseEntity<T>> put<T>(String url,
      {Object? data,
      Map<String, dynamic>? queryParams,
      CancelToken? cancelToken,
      Options? options,
