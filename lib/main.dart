...
import 'package:wanandroid_flutter/pages/MinePage.dart';
                ...
                itemBuilder: (BuildContext context, int position) {
                  return GestureDetector(
                    ...
                    onTap: () async {
                      ...
                      context.watch<ThemeProvide>()..setTheme(position);
                      //存储主题下标
