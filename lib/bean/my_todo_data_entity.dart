...
import '../generated/json/my_todo_data_entity.g.dart';
...
class MyTodoDataItem {
	...
	factory MyTodoDataItem.fromJson(Map<String, dynamic> json) => $MyTodoDataItemFromJson(json);

	Map<String, dynamic> toJson() => $MyTodoDataItemToJson(this);
