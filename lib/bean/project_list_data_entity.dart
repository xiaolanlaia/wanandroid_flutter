...
import '../generated/json/project_list_data_entity.g.dart';
...
class ProjectListDataItemEntity {
	...
	factory ProjectListDataItemEntity.fromJson(Map<String, dynamic> json) => $ProjectListDataItemEntityFromJson(json);

	Map<String, dynamic> toJson() => $ProjectListDataItemEntityToJson(this);
