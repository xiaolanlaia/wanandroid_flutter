...
import 'package:wanandroid_flutter/widget/my_taurus_footer.dart' as myTaurusFooter;
import 'package:wanandroid_flutter/widget/my_taurus_header.dart' as myTaurusHeader;
      ...
      body: TabBarView(
        ...
        children: _datas.map((ProjectData choice) {
          return EasyRefresh.custom(
            header: myTaurusHeader.TaurusHeader(),
            footer: myTaurusFooter.TaurusFooter(),
            onRefresh: () async {
