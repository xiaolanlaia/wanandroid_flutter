...
MyTodoDataItem $MyTodoDataItemFromJson(Map<String, dynamic> json) {
  final MyTodoDataItem myTodoDataItem = MyTodoDataItem();
  final int? completeDate = jsonConvert.convert<int>(json['completeDate']);
  if (completeDate != null) {
    myTodoDataItem.completeDate = completeDate;
  }
  final String? completeDateStr = jsonConvert.convert<String>(
      json['completeDateStr']);
  if (completeDateStr != null) {
    myTodoDataItem.completeDateStr = completeDateStr;
  }
  final String? content = jsonConvert.convert<String>(json['content']);
  if (content != null) {
    myTodoDataItem.content = content;
  }
  final int? date = jsonConvert.convert<int>(json['date']);
  if (date != null) {
    myTodoDataItem.date = date;
  }
  final String? dateStr = jsonConvert.convert<String>(json['dateStr']);
  if (dateStr != null) {
    myTodoDataItem.dateStr = dateStr;
  }
  final int? id = jsonConvert.convert<int>(json['id']);
  if (id != null) {
    myTodoDataItem.id = id;
  }
  final int? priority = jsonConvert.convert<int>(json['priority']);
  if (priority != null) {
    myTodoDataItem.priority = priority;
  }
  final int? status = jsonConvert.convert<int>(json['status']);
  if (status != null) {
    myTodoDataItem.status = status;
  }
  final String? title = jsonConvert.convert<String>(json['title']);
  if (title != null) {
    myTodoDataItem.title = title;
  }
  final int? type = jsonConvert.convert<int>(json['type']);
  if (type != null) {
    myTodoDataItem.type = type;
  }
  final int? userId = jsonConvert.convert<int>(json['userId']);
  if (userId != null) {
    myTodoDataItem.userId = userId;
  }
  return myTodoDataItem;
}

Map<String, dynamic> $MyTodoDataItemToJson(MyTodoDataItem entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
...
extension MyTodoDataItemExtension on MyTodoDataItem {
