...
import '../bean/my_shared_data_entity.dart';
...
class _MySharedPageState extends State<MySharedPage> {
  ...
  Future<bool> _requestData() async {
    ApiResponseEntity<MySharedDataEntity> res =
  ...
  Future<bool> _onShareClick() async {
    ...
    ApiResponseEntity<dynamic> res = await HttpGo.instance.post(Api.shareArticle,
